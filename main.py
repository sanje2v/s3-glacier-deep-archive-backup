...
from libs import backup, restore
from utils import *
import settings
...
if __name__ == '__main__':
    ...
    backup_parser.add_argument('--split-size', help='Split size in bytes. Default is 1 GB.', type=int, default=settings.DEFAULT_SPLIT_SIZE_KILOBYTES)
    ...
    backup_parser.add_argument('--compression-type', help='Type of compression to use on TAR file.', type=str, choices=('gz', 'bz2', 'xz'), default=settings.DEFAULT_TAR_COMPRESSION_TYPE)
