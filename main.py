...
if __name__ == '__main__':
    ...
    backup_parser.add_argument('--encrypt', help=f"Specify to encrypt the TAR file. Key will be saved in state database. Nonce is TAR filename, repeated to 12 characters. Default is encryption enabled.", action=argparse.BooleanOptionalAction, default=True)
